...
<html lang="en">
  <head>
    ...
    <title>Asto and Union / Canteen / Guest House  Edit</title>
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Asto and Union / Canteen / Guest House Edit 
                            <a href="astoindex.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM astos WHERE id='$data_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="astocode.php" method="POST">
                                    <input type="hidden" name="data_id" value="<?= $data['id']; ?>">

                                    <div class="mb-3">
                                        <label>Section</label>
                                        <input type="text" name="section" value="<?=$data['section'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Printer Model</label>
                                        <input type="text" name="printer" value="<?=$data['printer'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">

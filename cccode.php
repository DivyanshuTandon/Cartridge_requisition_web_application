...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM ccs WHERE id='$data_id' ";
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE ccs SET printer='$printer', number='$number', part='$part' WHERE id='$data_id' ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO ccs (printer,number,part) VALUES ('$printer','$number','$part')";

    $query_run = mysqli_query($con, $query);
    if($query_run)
    {
        $_SESSION['message'] = " Added Successfully";
        header("Location: cc-create.php");
        exit(0);
    }
    else
    {

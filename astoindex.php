...
<html lang="en">
  <head>
    ...
    <title>Asto and Union / Canteen / Guest House</title>
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Asto and Union / Canteen / Guest House Details
                        <a href="sectionindex.php" class="btn btn-danger float-end">BACK</a>
                        <br>
                        <br>
                        <a href="asto-create.php" class="btn btn-primary float-end">Add details</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $data)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="asto-view.php?id=<?= $data['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="asto-edit.php?id=<?= $data['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="astocode.php" method="POST" class="d-inline">

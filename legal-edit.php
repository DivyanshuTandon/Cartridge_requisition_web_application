            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Legal Edit 
                            <a href="legalindex.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM legals WHERE id='$data_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="legalcode.php" method="POST">

		...
		<div class="navbar-nav ml-auto">
			...
			<div class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a href="calendar.php" class="dropdown-item"><i class="fa fa-user-o"></i> Profile</a></a>
...
<html lang="en">
  <head>
    ...
    <title>Cartridge Request Form</title>
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4> 
                            Request Cartridge Form
                            <a href="userlogin.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="usercode.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="department" class="form-control" placeholder="typing...">
                            </div>
                            <div class="mb-3">
                                <label>Printer number</label>
                                <input type="text" name="printer" class="form-control" placeholder="typing...">
                            </div>
                            <div class="mb-3">
                                <label>Cartridge number</label>
                                <input type="text" name="cartridge" class="form-control" placeholder="typing...">
                            </div>
                            <div class="mb-3">
                                <label>Cartridge deposited by user</label>
                                <select id="cartridge_deposited_by_user" name="deposited" class="form-control"> 

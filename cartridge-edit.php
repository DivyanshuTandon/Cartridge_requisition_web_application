                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM stocks WHERE id='$data_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="code.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label>Part No Of Cartridge</label>
                                        <input type="text" name="part" value="<?=$data['part'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Old stock </label>
                                        <input type="text" name="old" value="<?=$data['old'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>New stock </label>
                                        <input type="text" name="new" value="<?=$data['new'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Total Stock including new lot</label>
                                        <input type="text" name="total" value="<?=$data['total'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Current Stock</label>
                                        <input type="text" name="current" value="<?=$data['current'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Total issued</label>
                                        <input type="text" name="issued" value="<?=$data['issued'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">

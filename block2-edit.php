            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Block 2 Edit 
                            <a href="block2index.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM blocks WHERE id='$data_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="block2code.php" method="POST">

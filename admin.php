...
<html lang="en">
  <head>
    ...
    <title>Hardware stock Report</title>
</head>
<body>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>    CARTRIDGE DATA
                            ...
                            <br>
                            <br>
                            <a href="cartridge-create.php"class="btn btn-primary float-end">Add detail</a>
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>ID</th>
                                <th>Part No Of Cartridge</th>
                                <th>Old Stock   </th>
                                <th>New Stock </th>
                                <th>Total  Stock <br> including new lot</th>
                                <th>Current Stock</th>
                                <th>Total issued</th>
                                <th>Action</th>
                            </tr>
                                    ...
                                    foreach($query_run as $data)
                                    {
                                        ...
                                        <tr>
                                               ...
                                               <td>
                                                   ...
                                                   <a href="cartridge-view.php?id=<?= $data['id']; ?>"class="btn btn-info btn-sm">view</a>
                                                   <a href="cartridge-edit.php?id=<?= $data['id']; ?>"class="btn btn-success btn-sm">Edit</a>

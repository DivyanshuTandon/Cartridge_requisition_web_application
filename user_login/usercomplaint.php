...
.nav-link img {
    ...
    <body>
      ...
      <nav class="navbar navbar-expand-xl navbar-light bg-light">
       ...
       <a href="userlogin.php" class="nav-item nav-link active" > <i class="fa fa-fw fa-home"></i> Home</a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="usercomplaintcode.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="complaint" class="form-control" placeholder="typing...">
                            </div>

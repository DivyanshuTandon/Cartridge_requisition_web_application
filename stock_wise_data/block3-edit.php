...
<html lang="en">
  <head>
    ...
    <title>Block 3 Edit</title>
</head>
<body>
  
    <div class="container mt-5">

        <?php include('bsectionmessage.php'); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Block 3 Edit 
                            <a href="block3index.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM blocs WHERE id='$data_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="block3code.php" method="POST">

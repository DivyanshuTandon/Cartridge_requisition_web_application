            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <br>
                        <br>
                        <a href="block3-create.php" class="btn btn-primary float-end">Add details</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $data)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="block3-view.php?id=<?= $data['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="block3-edit.php?id=<?= $data['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="block3code.php" method="POST" class="d-inline">

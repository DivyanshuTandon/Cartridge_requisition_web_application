...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM cms WHERE id='$data_id' ";
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE cms SET printer='$printer', number='$number', part='$part', issued='$issued' WHERE id='$data_id' ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO cms (printer,number,part,issued) VALUES ('$printer','$number','$part','$issued')";

    $query_run = mysqli_query($con, $query);
    if($query_run)
    {
        $_SESSION['message'] = " Created Successfully";
        header("Location: cm-create.php");
        exit(0);
    }
    else
    {

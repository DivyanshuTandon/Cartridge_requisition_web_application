...
<html lang="en">
  <head>
    ...
    <title>Finance and Govt. Audit Edit</title>
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Finance and Govt. Audit Edit 
                            <a href="fagaindex.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM fagas WHERE id='$data_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="fagacode.php" method="POST">

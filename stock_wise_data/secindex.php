...
<html lang="en">
  <head>
    ...
    <title>Security / Sectoral-HSE</title>
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Security / Sectoral-HSE Details
                        <a href="sectionindex.php" class="btn btn-danger float-end">BACK</a>
                        <br>
                        <br>
                        <a href="sec-create.php" class="btn btn-primary float-end">Add details</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $data)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="sec-view.php?id=<?= $data['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="sec-edit.php?id=<?= $data['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="seccode.php" method="POST" class="d-inline">

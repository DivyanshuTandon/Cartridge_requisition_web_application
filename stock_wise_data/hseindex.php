...
<html lang="en">
  <head>
    ...
    <title>HSE Basin / Geophysical Service</title>
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>HSE Basin / Geophysical Service Details
                        <a href="sectionindex.php" class="btn btn-danger float-end">BACK</a>
                        <br>
                        <br>
                        <a href="hse-create.php" class="btn btn-primary float-end">Add details</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $data)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="hse-view.php?id=<?= $data['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="hse-edit.php?id=<?= $data['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="hsecode.php" method="POST" class="d-inline">

...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM secs WHERE id='$data_id' ";
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE secs SET section='$section',printer='$printer', number='$number', part='$part' WHERE id='$data_id' ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO secs (section,printer,number,part) VALUES ('$section','$printer','$number','$part')";

    $query_run = mysqli_query($con, $query);
    if($query_run)
    {
        $_SESSION['message'] = " Created Successfully";
        header("Location: sec-create.php");
        exit(0);
    }
    else
    {
